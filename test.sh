...
test_command="${python_command} muni.py --list-routes BART"
output=`${python_command} muni.py --list-routes BART`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-routes Caltrain"
output=`${python_command} muni.py --list-routes Caltrain`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-routes 'Dumbarton Express'"
output=`${python_command} muni.py --list-routes 'Dumbarton Express'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-routes LAVTA"
output=`${python_command} muni.py --list-routes LAVTA`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-routes 'Marin Transit'"
output=`${python_command} muni.py --list-routes 'Marin Transit'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-routes SamTrans"
output=`${python_command} muni.py --list-routes SamTrans`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-routes SF-MUNI"
output=`${python_command} muni.py --list-routes SF-MUNI`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-routes 'Vine (Napa County)'"
output=`${python_command} muni.py --list-routes 'Vine (Napa County)'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-routes VTA"
output=`${python_command} muni.py --list-routes VTA`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-routes WESTCAT"
output=`${python_command} muni.py --list-routes WESTCAT`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-stops 'AC Transit~1~South'"
output=`${python_command} muni.py --list-stops 'AC Transit~1~South'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-stops 'AC Transit~1~North'"
output=`${python_command} muni.py --list-stops 'AC Transit~1~North'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-stops 'Dumbarton Express~DB~West'"
output=`${python_command} muni.py --list-stops 'Dumbarton Express~DB~West'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-stops 'Dumbarton Express~DB~East'"
output=`${python_command} muni.py --list-stops 'Dumbarton Express~DB~East'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-stops LAVTA~12~Eastbound"
output=`${python_command} muni.py --list-stops LAVTA~12~Eastbound`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-stops LAVTA~1~LOOP"
output=`${python_command} muni.py --list-stops LAVTA~1~LOOP`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-stops 'Marin Transit~113~1728'"
output=`${python_command} muni.py --list-stops 'Marin Transit~113~1728'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-stops 'SamTrans~14~CLOCKWIS'"
output=`${python_command} muni.py --list-stops 'SamTrans~14~CLOCKWIS'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-stops SamTrans~252~COUNTERC"
output=`${python_command} muni.py --list-stops SamTrans~252~COUNTERC`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-stops 'Vine (Napa County)~2~LP'"
output=`${python_command} muni.py --list-stops 'Vine (Napa County)~2~LP'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-stops 'Vine (Napa County)~8~S'"
output=`${python_command} muni.py --list-stops 'Vine (Napa County)~8~S'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-stops VTA~42~North"
output=`${python_command} muni.py --list-stops VTA~42~North`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-stops 'WESTCAT~C3~TO COLLEGE'"
output=`${python_command} muni.py --list-stops 'WESTCAT~C3~TO COLLEGE'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-stops 'WESTCAT~19~TO HILLTOP MALL'"
output=`${python_command} muni.py --list-stops 'WESTCAT~19~TO HILLTOP MALL'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list-stops WESTCAT~10~LOOP"
output=`${python_command} muni.py --list-stops WESTCAT~10~LOOP`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
