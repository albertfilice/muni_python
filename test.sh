...
test_command="${python_command} muni.py --list_routes 'AC Transit'"
output=`${python_command} muni.py --list_routes 'AC Transit'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_routes BART"
output=`${python_command} muni.py --list_routes BART`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_routes Caltrain"
output=`${python_command} muni.py --list_routes Caltrain`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_routes 'Dumbarton Express'"
output=`${python_command} muni.py --list_routes 'Dumbarton Express'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_routes LAVTA"
output=`${python_command} muni.py --list_routes LAVTA`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_routes SamTrans"
output=`${python_command} muni.py --list_routes SamTrans`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_routes SF-MUNI"
output=`${python_command} muni.py --list_routes SF-MUNI`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_routes 'Vine (Napa County)'"
output=`${python_command} muni.py --list_routes 'Vine (Napa County)'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_routes WESTCAT"
output=`${python_command} muni.py --list_routes WESTCAT`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
echo "#################" | tee -a "logs/templog.txt"
echo "" | tee -a "logs/templog.txt"
echo "AC Transit" | tee -a "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops 'AC Transit~1~South'"
output=`${python_command} muni.py --list_stops 'AC Transit~1~South'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops 'AC Transit~1~North'"
output=`${python_command} muni.py --list_stops 'AC Transit~1~North'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
else
	printf "\e[31;4mFAIL\e[0m: $test_command\n" | tee -a -a "logs/templog.txt"
	echo $output >> "logs/templog.txt"
	echo $expected_result >> "logs/templog.txt"
fi
...
test_command="${python_command} muni.py --list_stops BART~747"
output=`${python_command} muni.py --list_stops BART~747`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops 'Caltrain~BABY BULLET~NB'"
output=`${python_command} muni.py --list_stops 'Caltrain~BABY BULLET~Nb'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops 'Caltrain~BABY BULLET~SB1'"
output=`${python_command} muni.py --list_stops 'Caltrain~BABY BULLET~SB1'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
echo "" | tee -a "logs/templog.txt"
echo "Dumbarton Express" | tee -a "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops 'Dumbarton Express~DB~West'"
output=`${python_command} muni.py --list_stops 'Dumbarton Express~DB~West'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops 'Dumbarton Express~DB~East'"
output=`${python_command} muni.py --list_stops 'Dumbarton Express~DB~East'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
echo "" | tee -a "logs/templog.txt"
echo "LAVTA" | tee -a "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops LAVTA~12~Eastbound"
output=`${python_command} muni.py --list_stops LAVTA~12~Eastbound`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops LAVTA~1~LOOP"
output=`${python_command} muni.py --list_stops LAVTA~1~LOOP`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
echo "" | tee -a "logs/templog.txt"
echo "Marin Transit" | tee -a "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops 'Marin Transit~113~1728'"
output=`${python_command} muni.py --list_stops 'Marin Transit~113~1728'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
echo "" | tee -a "logs/templog.txt"
echo "SamTrans" | tee -a "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops 'SamTrans~14~CLOCKWIS'"
output=`${python_command} muni.py --list_stops 'SamTrans~14~CLOCKWIS'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops SamTrans~252~COUNTERC"
output=`${python_command} muni.py --list_stops SamTrans~252~COUNTERC`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops SF-MUNI~N~Outbound"
output=`${python_command} muni.py --list_stops SF-MUNI~N~Outbound`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
echo "" | tee -a "logs/templog.txt"
echo "Vine (Napa County)" | tee -a "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops 'Vine (Napa County)~2~LP'"
output=`${python_command} muni.py --list_stops 'Vine (Napa County)~2~LP'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops 'Vine (Napa County)~8~S'"
output=`${python_command} muni.py --list_stops 'Vine (Napa County)~8~S'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
echo "" | tee -a "logs/templog.txt"
echo "VTA" | tee -a "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops VTA~42~North"
output=`${python_command} muni.py --list_stops VTA~42~North`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
echo "" | tee -a "logs/templog.txt"
echo "WESTCAT" | tee -a "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops 'WESTCAT~C3~TO COLLEGE'"
output=`${python_command} muni.py --list_stops 'WESTCAT~C3~TO COLLEGE'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops 'WESTCAT~19~TO HILLTOP MALL'"
output=`${python_command} muni.py --list_stops 'WESTCAT~19~TO HILLTOP MALL'`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
...
test_command="${python_command} muni.py --list_stops WESTCAT~10~LOOP"
output=`${python_command} muni.py --list_stops WESTCAT~10~LOOP`
output=`echo $output`
if [[ "$output" == "$expected_result" ]] ; then
	printf "\e[32mPASS\e[0m: $test_command\n"
	echo "PASS: $test_command" >> "logs/templog.txt"
